  ...
  setCompatability = arr => {
    for (let i = 0; i < arr.length; i++) {
      let user1 = {
        ...
        hair_color: "brown",
        image1:
          "https://tse2.mm.bing.net/th?id=OIP.gkbT_J7jAwS-6zUxEdP7wAHaFY&pid=Api&P=0&w=224&h=163",
        image2: 1,
        image3: 1,
        age: 25,
        age_min: 18,
          ...
          <div>
            {compatable.slice(0, 1).map(profile => (
              <Swipe
                ...
                onSwipeLeft={() => this.actionSwipeLeft(profile.user_id)}
                onSwipeRight={() => {
...
export default connect(
  mapStateToProps,
  { getPotentialMatches, swipeLeft, swipeRight }
)(Home);
