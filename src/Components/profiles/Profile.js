...
export default class Profile extends Component {
  constructor(props) {
    super(props);
    this.state = {
        defaultImg1: "https://images.unsplash.com/photo-1518783079920-3ff64f0da9ba",
        defaultImg2: "https://images.unsplash.com/photo-1535911062114-764574491173",
        defaultImg3: "https://images.unsplash.com/photo-1523772721666-22ad3c3b6f90",
        defaultImg4: "https://images.unsplash.com/photo-1516469727881-f4458e7cee17",
        editing: false,
  ...
  handleSubmit = async() => {
    ...
    await this.props.editUserProfile(age, name, religion, ethnicity, description, gender)
    this.flipEdit()
  ...
  render() {
    ...
    let { defaultImg1, defaultImg2, defaultImg3, defaultImg4, editing, races, religions} = this.state;
        ...
        
        {
          ...
          <div>
                <div className="Profile_User">
                  <input placeholder={profile.name} name='name' onChange={this.handleChange}/>, 
                  <span><input placeholder={profile.age} onChange={this.handleChange} name='age'/></span>
                </div>
      
              <div className="Border" />
              
              <div className="Profile_Desc"><input placeholder={profile.description} name='description' onChange={this.handleChange}/></div>
              ...
              <div>
                  ...
                  <input type="radio" name="gender" value="male" onChange={this.handleChange} id="male"/>
                  <label for="male" className="male_label"><i className="fas fa-male" />Male</label>
                  
                  <input type="radio" name="gender" value="female" onChange={this.handleChange} id="female"/>
                  <label for="female" className="female_label"><i type="radio" className="fas fa-female" />Female</label>
                  </div>
