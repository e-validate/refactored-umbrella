        ...
        return (
            <div>
                <div className='login_container'>
                    <input className='login_inputs' id='login-input-one' type='text' placeholder='Enter email' name='email' value={email} onChange={this.handleChange}/>
                    ...
                    <Link to='/register' className='link_to_register'>Not a member?</Link>
                </div>
