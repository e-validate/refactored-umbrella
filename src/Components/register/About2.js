...
import {
  ...
  editUserDetails,
  editUserInterests,
  getUserDetailsAndInterests
} from "./../../ducks/reducers/formReducer";
import { Link } from "react-router-dom";
import Login_About2 from "./Login_About2";
...
class About2 extends Component {
  ...
  async componentDidMount() {
    let { getUserDetailsAndInterests } = this.props;
    await getUserDetailsAndInterests();
  }
  ...
  render() {
    ...
    console.log("props in login1", this.props);
    return (
      <div>
        {formDetails ? (
          <div className="Login2">
            {formDetails.map(form => (
              <Login_About2
                key={form.user_id}
                form={form}
                editUserDetails={this.props.editUserDetails}
                editUserInterests={this.props.editUserInterests}
                gender={this.props.formDetails[0].gender}
                user_details_id={this.props.formDetails[0].user_details_id}
                user_interests_id={this.props.details.user_interests_id}
              />
            ))}
          </div>
        ) : (
